...
\subsection{Un example concret : le langage OCaml}
\begin{frame}
    \frametitle{Un example concret : le langage OCaml\esp}
        ...
        \only<2->{
            ...
            \uncover<4->{
                \begin{itemize}
                    ...
                    \item Compilateur simpliste voué explicitement au
                          bootstrapping du compilateur.
                \end{itemize}
            }
        }
    \end{center}
